...
chapter_parser.add_argument('name', required=True)
chapter_parser.add_argument('content', required=True)
chapter_parser.add_argument('number', required=True, type=int)
